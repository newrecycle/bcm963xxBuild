...
static char *nandUpdateSeqNum(unsigned char *imagePtr, int imageSize, int blkLen)
{
    ...
    int seqnum2=-1;
#endif
#if defined(GPL_A_CONFIG_JFFS) && defined(GPL_CODE_B_DUAL_IMAGE)
...
#if defined(GPL_CODE_B_BACKUP_TAG)
...
#if defined(GPL_CODE_C) && defined(GPL_A_TWO_IN_ONE_FIRMWARE)
...
#if defined(GPL_CODE_B_UPGRADE_HISTORY_SPAD)
	/* get upgradeHistroy */
    char *uph;
	int upgradeRet = 0;
#if defined(GPL_A_CONFIG_JFFS)
