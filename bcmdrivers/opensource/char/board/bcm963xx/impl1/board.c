...
#if defined(GPL_CODE_B_CHIP_D0_CHECK)
int  CPURevId=0;
...
#if defined(GPL_CODE_B_DOWNGRADE_NVRAM_ADJUST)
...
#elif defined(GPL_CODE_T)
#if defined(GPL_CODE_T_T2200H) || defined(GPL_CODE_TT)
 #define FACTORY_HOLD_TIME    4
#if defined(GPL_A_INTERNET_LED_BEHAVIOR)
...
#endif
#if defined(GPL_A_FACTORY_TEST)
static int g_RMA_status = 0;
#endif

#if defined(GPL_CODE_T) || defined(GPL_CODE_C)
...
#if   defined(CONFIG_BCM_6802_MoCA)
#if defined(GPL_A_MULT_BOARD_ID_IN_ONE_FIRMWARE)
...
unsigned long kerSysGetMacAddressType( unsigned char *ifName )
{
    ...
    {
#if defined(GPL_CODE_C_STATIC_MAC_ADDR)
...
#endif	
    {
#if defined(GPL_CODE_T_STATIC_MAC_ADDR)
    /*
...
#if defined(GPL_CODE_A_SASKTEL_STATIC_MAC_ADDR)
    /*
...
#if defined(GPL_CODE_B) || defined(GPL_CODE_C_STATIC_MAC_ADDR)
    if(ulId == 0x13ffffff)
    {
...
#if defined(GPL_CODE_B_DUAL_IMAGE)
...
#if defined(GPL_CODE) && !defined(GPL_CODE_B_DUAL_IMAGE)
    char *p;
#endif
    char *tagFs = imagePtr;
...
static int aei_getNvramValueByParaName(AEI_NVRAM_PARAM_INDEX pIndex, char* parValue, int len)
{
    ...
    case AEI_NVPARAM_BOOTLINE:
        ...
        break;
#if defined(GPL_A_24G_WIFI_CALIBRATION_TEST_SUPPORT)
    ...
    case AEI_NVPARAM_WLANFEATURE:
        *parValue = nvramData.wlanParams[NVRAM_WLAN_PARAMS_LEN-1];
        break;
#if defined(GPL_A_DETECT_BOARD_ID)
                       ...
                       unsigned int command, unsigned long arg )
{
    ...
    case BOARD_IOCTL_FLASH_WRITE:
        if (copy_from_user((void*)&ctrlParms, (void*)arg, sizeof(ctrlParms)) == 0) {
           ...
           case AEI_IMAGE2_PSI:
                ...
                break;
#endif
#ifdef GPL_A_CUSTOMER_REVERT_FIRMWARE_CONFIG
            case OLD_IMAGE_PSI:
...
#if defined(GPL_CODE_B_CONSOLE_SECURITY_MODE)
...
#endif
#if defined(GPL_CODE_B_SECURITY_LEVEL_3)
#if defined(GPL_CODE_B_SECURITY_LEVEL_3_TR)
        ...
        break;
...
#endif
#endif   //GPL_CODE
#if defined(GPL_CODE_B_DEBUG_NVRAM)
         case BOARD_IOCTL_PRINT_NVRAM:
			//if (copy_from_user((void*)&ctrlParms, (void*)arg, sizeof(ctrlParms)) == 0)
            {
             ...
             break;
#endif
#if defined(GPL_CODE_B_UPGRADE_DUALIMG_HISTORY_SPAD) || defined(GPL_A_CUSTOMER_REVERT_FIRMWARE_CONFIG)
            ...
            sizeof(ctrlParms)) == 0)
       {
           ...
           if (ctrlParms.offset==0){ //image 0
               if( ctrlParms.string )
               {
                   ...
                   if(pTag1)
                   {
#if defined(GPL_A_TWO_IN_ONE_FIRMWARE)
                       unsigned char boardid[16]={0};
#endif
#if defined(GPL_A_TWO_IN_ONE_FIRMWARE) && defined(GPL_CODE_C)
...
#if defined(GPL_CODE_B_SMARTLED)
    case BOARD_IOCTL_SET_INET_TRAFFIC_BLINK:
        if (copy_from_user((void*)&ctrlParms, (void*)arg, sizeof(ctrlParms)) == 0) {
            register uint32 *pv32;

#ifdef GPL_A_6368_CHIP //For 6368
        ...
        break;
#endif /* GPL_CODE_B_SMARTLED */
#if defined(GPL_CODE_B_CHECK_FLASH_ID)
    ...
    case AEI_BOARD_IOCTL_SET_WAN_TYPE:
        ...
        break;
#endif
#if defined(GPL_CODE_B_FACTORY_TELNET)
...
#if defined(GPL_CODE_B) || defined(GPL_CODE_T) || defined(SUPPORT_BACKUP_PSI)
...
#if defined(GPL_A_BAND_STEERING)
...
#endif
#if defined(GPL_A_CONSOLE)
    sys_unlink("/data/aei_consolg_enable");
#endif
#if defined(GPL_A_WPS_LOCKDOWN_LOG)
...
#else
void AEI_resetBtnTimerFunc(unsigned long data)
{
    INIT_WORK(&restoreDefaultWork, restore_to_default_thread);
    schedule_work(&restoreDefaultWork);
    return;
...
#if defined(GPL_CODE_B_DUAL_IMAGE) || defined(GPL_A_VER2_DUAL_IMAGE)
...
#if defined(GPL_A_VER2_DUAL_IMAGE)
	PFILE_TAG pTag1 = getTagFromPartition(1);
	PFILE_TAG pTag2 = getTagFromPartition(2);
...
#if defined(GPL_CODE_B_DUAL_IMAGE) || defined(GPL_A_VER2_DUAL_IMAGE) || defined(GPL_A_FACTORY_TEST)
...
#if !defined(GPL_A_PROHIBIT_MODIFY_NVRAM)
...
#ifdef GPL_A_TWO_IN_ONE_FIRMWARE
...
#if defined(GPL_CODE) && defined(GPL_A_63138_CHIP)
