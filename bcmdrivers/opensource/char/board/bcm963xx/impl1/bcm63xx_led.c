...
#if defined(GPL_CODE_C) && defined(GPL_A_63168_CHIP)
...
#if defined(GPL_CODE)
#if !defined(GPL_CODE_TT) && !defined(GPL_A_63168_CHIP)
...
int __init bcmsysfsleds_init(void)
{
	...
	int index=0, token=0, rc;
        ...
        for(;;) {
                ledName=NULL;
#if defined(GPL_A_63138_CHIP)
#if defined(GPL_CODE_TT) || defined(GPL_CODE_C)
