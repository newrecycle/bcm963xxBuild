...
#endif
#if defined(GPL_A_CONFIG_JFFS) || defined(GPL_CODE_B_UPGRADE_DUALIMG_HISTORY_SPAD) || defined(GPL_A_CUSTOMER_REVERT_FIRMWARE_CONFIG)
...
#if 0
#if defined(GPL_A_63168_CHIP) // For 63168
...
#if defined(GPL_CODE_C) || defined(GPL_CODE_TT)
