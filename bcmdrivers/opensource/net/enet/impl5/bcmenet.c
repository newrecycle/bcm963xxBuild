...
#if defined(GPL_A_SUPPORT_100M_ETH_RELINK)
...
#endif
#if defined(GPL_CODE_B_MUTIL_WAN_ETHERNET_PHY)
UBOOL8 g_wan_eth_link_up = FALSE;
UBOOL8 g_wan_sfp_link_up = FALSE;
#endif

#if defined(GPL_CODE_B_SW_WAN_ETH_LED) || defined(GPL_CODE_B_INET_LED_BLINK)
int enetWanLedOn=0;
#if defined(GPL_CODE_B_INET_LED_BLINK) || defined(GPL_CODE_B_SMARTLED)
...
#if defined(GPL_CODE) && !defined(GPL_A_63168_CHIP)
...
#if defined(GPL_CODE_B_POWERSAVE)
...
#if defined(GPL_A_63138_CHIP) && defined(GPL_CODE)// && defined(CONFIG_BRCM_CHIP_VER_A0)
...
#if defined(CONFIG_BCM_JUMBO_FRAME) && !defined(CONFIG_BCM_MAX_MTU_SIZE)
    {
        int we_locked_rtnl = FALSE;
            ...
            if (LOGICAL_PORT_TO_UNIT_NUMBER(port) == 0)
            {
                ...
                {
#if !defined(GPL_CODE_B_TELUS_T3200_SFP_LED)
...
#if defined(GPL_A_63138_CHIP) && defined(CONFIG_BRCM_CHIP_VER_A0)
...
-------------------------------------------------------------------------- */
#if defined(GPL_A_LOAD_BALANCING_CONTROL)
...
#if defined(GPL_CODE) && !defined(GPL_A_63168_CHIP) && !defined(GPL_A_63138_CHIP)
        ...
        case SIOCETHSWCTLOPS:
            switch(e->op) {
                ...
                case ETHSWPORTSTORMCTRL:
                    ...
                    break;
#if defined(GPL_A_EXT_SWITCH_PORT_ISOLATE)
        ...
        case SIOCETHCTLOPS:
            switch(ethctl->op) {
                ...
                case ETHSETMIIREG:       /* Write MII PHY register. */
                    ...
                    break;
#if defined(GPL_CODE_B_WAN_CONVERT_LAN)
