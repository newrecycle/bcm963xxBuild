...
#endif
#if defined(GPL_A_63138_CHIP) && defined(GPL_CODE)
...
#endif
#if defined(GPL_A_SCKIPIO_SUPPORT)
...
#if defined(GPL_A_SFP_DETECTION_BY_GPIO)
...
{
#if defined(GPL_CODE_B_63138_WAN_ETHER_LINK_PATCH)
...
#endif
#if defined(GPL_CODE_B_63138_LAN_ETHER_LINK_PATCH)
    {
        //enable ethernet@wirespeed of GE port
        uint16 v16;
