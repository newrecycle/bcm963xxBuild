...
-- Copyright (c) 2017-2018 CUJO LLC. All rights reserved.
--
...
cujo.nf.dostring('config = ' .. serializer:tostring(cujo.config.nf))
cujo.nf.subscribe('log', function(msg) cujo.log:error(table.unpack(msg)) end)
...
for _, script in ipairs(scripts) do
	...
	cujo.nf.dostring(assert(cujo.filesys.readfrom(path, 'a')))
end
