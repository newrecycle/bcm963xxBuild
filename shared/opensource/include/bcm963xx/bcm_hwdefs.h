...
#if  defined(_BCM96838_) || defined(_BCM963138_) || defined(_BCM963148_) || defined(_BCM96848_) || defined(GPL_A_63138_CHIP)
...
#if defined(GPL_CODE_B_CONSOLE_SECURITY_MODE) || defined(GPL_CODE)
    -16
#endif
#if defined(GPL_CODE_B_SECURITY_LEVEL_3) || defined(GPL_CODE)
     -1
#endif
#if defined(GPL_A_FACTORY_TEST) || defined(GPL_CODE)
     -4
#endif
#if defined(GPL_A_DETECT_BOARD_ID) || defined(GPL_CODE)
     -1
#endif
     -1 /*AEI unused*/
     ];
