...
ifneq ($(strip $(GPL_CODE_NCS)),)
GPL_CODE_PRODUCTINFO_FILE := shared/opensource/include/bcm963xx/GPL_CODE_productinfo.h
$(GPL_CODE_PRODUCTINFO_FILE): $(BUILD_DIR)/version.make
	@echo "creating bcm release version header file"
	@echo "/* this file is automatically generated from top level Makefile */" > $(GPL_CODE_PRODUCTINFO_FILE)
	@echo "#ifdef GPL_CODE_NCS" >> $(GPL_CODE_PRODUCTINFO_FILE)
	@echo "#define GPL_CODE_CUSTOMER \"$(ACT_CUSTOMER)\"" >> $(GPL_CODE_PRODUCTINFO_FILE)
	@echo "#define GPL_CODE_MODEL \"$(ACT_PROJECT)\"" >> $(GPL_CODE_PRODUCTINFO_FILE)
	@echo "#endif" >> $(GPL_CODE_PRODUCTINFO_FILE)
endif
...
#
create_install: $(GPL_CODE_PRODUCTINFO_FILE)
		@echo "CFFF=$(GPL_CODE_PRODUCTINFO_FILE)"
...
kernelbuild: kernellinks $(BCM_SWVERSION_FILE) $(GPL_CODE_PRODUCTINFO_FILE)
...
#GPL_CODE_NCS begin
ifneq ($(strip $(GPL_CODE_CONFIG_JFFS)),)
ifeq ($(strip $(BUILD_NAND_IMG_BLKSIZE_16KB)),y)
    ifeq ($(strip $(BRCM_CHIP)),63268)
	cd $(PROFILE_DIR); \
	$(HOSTTOOLS_DIR)/AEINandImageBuilder $(BRCM_ENDIAN_FLAGS) --output rootfs16kbtag.img --release $(GPL_CODE_RELEASETAG) $(IMAGE_BUILD_OPTION_RELEASE2) $(BRCM_RELEASETAG2) $(IMAGE_BUILD_OPTION_RELEASE3) $(BRCM_RELEASETAG3) --chip $(BRCM_CHIP) --board $(BRCM_BOARD_ID) --blocksize 16  --rootfsfile jffs2_rootfs16kb.img ; \
...
ifeq ($(strip $(BUILD_NAND_IMG_BLKSIZE_128KB)),y)
	cd $(PROFILE_DIR); \
	$(HOSTTOOLS_DIR)/AEINandImageBuilder $(BRCM_ENDIAN_FLAGS) --output rootfs128kbtag.img --release $(GPL_CODE_RELEASETAG) $(IMAGE_BUILD_OPTION_RELEASE2) $(BRCM_RELEASETAG2) $(IMAGE_BUILD_OPTION_RELEASE3) $(BRCM_RELEASETAG3) --chip $(BRCM_CHIP) --board $(BRCM_BOARD_ID) --blocksize 128  --rootfsfile jffs2_rootfs128kb.img ; \
	$(HOSTTOOLS_DIR)/AEINandImageBuilder $(BRCM_ENDIAN_FLAGS) --output bootfs128kbtag.img --release $(GPL_CODE_RELEASETAG) $(IMAGE_BUILD_OPTION_RELEASE2) $(BRCM_RELEASETAG2) $(IMAGE_BUILD_OPTION_RELEASE3) $(BRCM_RELEASETAG3) --chip $(BRCM_CHIP) --board $(BRCM_BOARD_ID) --blocksize 128  --rootfsfile bootfs128kb.img ;
endif

# special case for cloud image
...
ifeq ($(strip $(BUILD_NAND_IMG_BLKSIZE_128KB)),y)
	...
	@echo
	@echo -e "Done! Image $(PROFILE) has been built in $(PROFILE_DIR)."
endif #GPL_CODE_CONFIG_JFFS
#endif #GPL_CODE_NCS end
