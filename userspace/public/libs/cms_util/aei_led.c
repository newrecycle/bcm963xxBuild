...
{
#if defined(GPL_CODE_C) && !defined(GPL_A_INTERNET_LED_BEHAVIOR)
...
{
#if defined(GPL_A_INTERNET_LED_BEHAVIOR) && defined(GPL_CODE_C)
...
#if defined(SUPPORT_DSL_BONDING) && defined(GPL_CODE_Q)
