...
#if 0 //def GPL_A_FACTORY_TEST
CmsRet getBoardSerialNumber(UINT8 *SerialNumber)
{
   return(devCtl_boardIoctl(0x22222,
                            0,
                            (char *) SerialNumber,
                            32,
                            0,
