...
#if defined(GPL_CODE_B_WP) && defined(GPL_CODE_B_DHCP_LEASE)
#include "aei_cms.h"
#endif
...
#ifdef GPL_A_AUTODNS_VULNERABLE
   CMS_MSG_DNSPROXY_UPDATE_DENIED_SITES         = 0x10000274, /**< Sent to dnsproxy to inform the denied sites update */
#endif
...
#if defined(GPL_A_SIGNED_FIRMWARE)
...
#if defined(GPL_CODE_B_HPNA) && defined(GPL_CODE_B_WT107)
...
#endif
#if defined(GPL_CODE_B_DETECT_WAN_SERVICE) || defined(GPL_CODE_B_TELUS_DETECT_WAN_SERVICE)
   CMS_MSG_DETECT_WAN_SERVICE                   = 0x10002627,
#endif
#if defined(DMP_TRACEROUTE_1)
   CMS_MSG_TRACE_ROUTE_STATE_CHANGE             = 0x10002628,
#endif
#if defined(GPL_CODE_B_QOS)
...
#endif
#if defined(GPL_CODE_B_DHCP_LEASE)
...
#endif
#if defined(GPL_CODE_T)
   CMS_MSG_WPSCOUNT_SYNC                        = 0x10002659,
#endif
//#if defined(GPL_CODE_T) || defined(GPL_CODE_B_TR098_QWEST) || defined(GPL_CODE_B)
#if defined(GPL_CODE)
   CMS_MSG_DHCP_TIME_UPDATED                    = 0x10002660,
#endif
#if defined(GPL_CODE_C) || defined(GPL_CODE_B)
   CMS_MSG_NSLOOKUP_RESULT                      = 0x10002661,
#endif
#if defined(GPL_CODE_B_STATS_DIAG)
   CMS_MSG_STATS_DIAG_REQUEST                   = 0x10002662,
   CMS_MSG_STATS_DIAG_COMPLETED                 = 0x10002663,
#endif

#if defined(GPL_CODE_C) //add william 2012-4-25
...
#ifdef GPL_A_CONTROL_LAYER
#ifdef GPL_A_SUPPORT_IPV6_STATICROUTE
    CMS_MSG_AEI_CTL_INFOR_FOR_STATIC_ROUTE   = 0x10002664,
#endif
    CMS_MSG_AEI_CTL_GET_PHYTYPE_IFNAME       = 0x10002667,
#endif
#if defined(GPL_CODE_C) || defined(GPL_CODE_B_DHCP_AUTO_RESERVATION)
   CMS_MSG_SELECT_VALID_RESERVATION                = 0x10002669,
#endif
#if defined(GPL_A_SUPPORT_VOIP_PRE_REGISTER)
...
#endif
#if defined(GPL_CODE_B_TELUS_DETECT_WAN_SERVICE)
   CMS_MSG_TELUS_DETECT_WAN_SERVICE                   = 0x10002672,
#endif
#if defined(GPL_CODE_B_HPNA_NETINF_DIAG)
   CMS_MSG_NETINF_RESULT                           = 0x10002673,
#endif
#if defined(GPL_CODE_B_ADVANCED_WL_STATISTICS)
...
#endif
#if defined(GPL_A_SUPPORT_PARENT_CONTROL)
...
#ifdef GPL_A_TR069_WIFI_INIT
   CMS_MSG_WLMNGR_START_COMPLETED       = 0x20000009,
#endif

#if defined(GPL_A_SUPPORT_SCKIPIO_GFAST)
...
#if defined(GPL_A_TR181_WLMNGR)
#if defined(GPL_A_QTN_RGMII_RELOAD)
   CMS_MSG_QTN_RGMII_RELOAD              = 0x2000000F,
#endif
#endif
#ifdef GPL_A_SUPPORT_SCHEDULING_ACCESS_EXTEND
   CMS_MSG_NEED_UPDATE_SCHEDULING_ACCESS      = 0x20000010,  /*Send this to ssk to update scheduling access configure*/
#endif
#if defined(GPL_A_TELUS_CALL_CENTER)
   CMS_MSG_WAN_IP_RELEASE_RENEW         = 0x20000011,
#endif
#if defined(GPL_A_ENABLE_PROFILE_LOG)
   CMS_MSG_SET_PROFILE_LOG_LEVEL        = 0x20000020,
#endif

#if defined(GPL_A_SUPPORT_CUJO)
   CMS_MSG_START_CUJO        = 0x20000021,
   CMS_MSG_STOP_CUJO        = 0x20000022,
#endif
...
#if defined(GPL_CODE_B_WP) && defined(GPL_CODE_B_DHCP_LEASE)
    UINT32 isWP;
#if defined(GPL_CODE_B_WP_AUTO_CONFIG)
 ...
 *
 */
#if defined(GPL_CODE_A_DHCP_WAN_OPTION121)
...
#endif
//#if defined(GPL_CODE_T)
#if defined(GPL_CODE_A_DHCP_WAN_LEASETIME) //modify william 2011-11-29
...
#if defined(GPL_CODE_B_MYNETWORK)
typedef enum {
...
#ifdef GPL_A_AUTODNS_VULNERABLE
/** Data body for CMS_MSG_DNSPROXY_UPDATE_DENIED_SITES message type.
 *
 */
typedef struct
{
   char deniedSiteList[BUFLEN_256];
} DeniedSitesMsgBody;
#endif
...
#endif
#if defined(GPL_CODE_B_DHCP_LEASE)||defined(GPL_CODE_C)
...
#if defined(GPL_CODE) && defined(GPL_CODE_B_MYNETWORK)
/*
