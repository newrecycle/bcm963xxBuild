 ...
 *
 */
#if defined(GPL_CODE_B_PASSWORD_ENCRYPTION)
#define CMS_CONFIG_FILE_VERSION "3.5"
#else
...
#elif defined(GPL_CODE_B)||defined(GPL_CODE_T)
...
#if defined(DNS_PROBE) && defined(GPL_CODE_B_DNS_PROBE)
