...
typedef enum {
...
#endif
#if defined (GPL_CODE_B_DETECT_WAN_SERVICE)
   ...
   EID_MYNETWORK=5007,
#endif
#ifdef GPL_CODE_B_HPNA
   EID_INHPNA=5008,
   EID_NETPERD=5009,
#ifdef GPL_CODE_B_WT107
   ...
   EID_SMARTLED=5011,
#endif
#if defined(GPL_CODE_B_SMARTLED)  || defined (GPL_CODE_B)
   EID_NSLOOKUP=5012,
#endif
   ...
   EID_SAVESYSLOG=5017,
#endif
#if defined(GPL_CODE_A_NTPV4)
   EID_NTPV4=5018,
#endif
#if defined(GPL_CODE_B_HPNA_NETINF_DIAG)
    EID_NETINF=5019,
#endif
#if defined (GPL_CODE_B_CES)
   EID_CES=5020,
#endif
   ...
   EID_STATISTICS_COLLECT=5021,
    ...
    EID_PING6=5022,
#endif
#ifdef GPL_A_CONTROL_TRACEROUTE6
    EID_TRACEROUTE6=5023,
#endif
#if defined(GPL_CODE_B_CPU_SYSLOG)
    EID_CPULOGD=5024,
#endif
#if defined(GPL_CODE_B_CAPTIVE_PAGES)
    EID_IPTABLES=5025,
#endif
    ...
    EID_CLI=5027,
    EID_WGET=5028,
#if defined(GPL_A_TR181_WLMNGR) || defined(GPL_A_SUPPORT_WIFI_181)
   EID_WIFI_NEIGHBOR_DIAG=5029,
#endif
#endif
#ifdef GPL_A_COMMUNITY_WIFI
   EID_MYGRE=5030,
#endif
#if defined(GPL_A_DUMPMDM)
   EID_DUMPMDM=5032,
#endif
#if defined(GPL_A_DUMPCFG)
   EID_DUMPCFG=5033,
#endif
   ...
   EID_RESERVED=10000,   /* keep EID's >= 10000 reserved for future use */
    ...
    EID_SCKIPIOCTL=5031,
#endif
#if defined(GPL_A_TR69_MONITOR)
    EID_TR69_MONITOR=5034,
#endif
#if defined(GPL_A_SUPPORT_CUJO)
    EID_CUJO_WATCHDOG=5035,
#endif
#if defined(GPL_A_CMSLOCK_MONITOR)
    EID_CMSLOCK_MONITOR=5036,
#endif
EID_LAST=65535
} CmsEntityId;
