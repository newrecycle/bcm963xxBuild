...
#if defined(GPL_CODE_B_DSL_STATE_GUI_ACCESS_NO_AUTH)
...
#if defined(GPL_A_CONFIG_JFFS) && defined(GPL_CODE_C_C1000A)
...
int AEI_save_syslog();
#endif
#if defined(GPL_CODE_B_CDROUTER_TESTMODE_SUPPORT)
#define CDROUTER_CERTFILE   "/data/.cdrouter_certfile.pem"
#endif
#endif
