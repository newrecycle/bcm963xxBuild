...
#ifdef DMP_AEI_AUTODNS_VULNERABLE_1
    char *    X_ACTIONTEC_COM_DNS_Denied_Sites;	/**< X_ACTIONTEC_COM_DNS_Denied_Sites */
#endif
} IGDDeviceInfoObject;
...
typedef struct
{
    ...
    char *    X_ACTIONTEC_COM_HighPowerUNII1Delay;	/**< X_ACTIONTEC_COM_HighPowerUNII1Delay */
    UBOOL8    X_ACTIONTEC_COM_HighPowerUNII1DelayChanged;	/**< X_ACTIONTEC_COM_HighPowerUNII1DelayChanged */
    char *    X_ACTIONTEC_COM_HighPowerUNII1DelayTime;	/**< X_ACTIONTEC_COM_HighPowerUNII1DelayTime */
    UINT64    X_ACTIONTEC_COM_HighPowerUNII1DelayTimeSeconds;	/**< X_ACTIONTEC_COM_HighPowerUNII1DelayTimeSeconds */
...
/*! \brief Obj struct for InternetGatewayDevice.X_ACTIONTEC_COM_CMSLockMonitor.
 *
 * MDMOID_AEI_CMS_LOCK_MONITOR 4559
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
    UBOOL8    enable;	/**< Enable */
    UINT32    lockHoldingTime;	/**< LockHoldingTime */
    UINT32    maxNumRestartCheck;	/**< MaxNumRestartCheck */
    UBOOL8    enableRestart;	/**< EnableRestart */
    UBOOL8    enableReboot;	/**< EnableReboot */
    char *    rebootStartTime;	/**< RebootStartTime */
    char *    rebootEndTime;	/**< RebootEndTime */
    char *    restart_History;	/**< Restart_History */
    char *    reboot_History;	/**< Reboot_History */
    char *    lockEventsLog;	/**< LockEventsLog */
} AEICmsLockMonitorObject;

/*! \brief _AEICmsLockMonitorObject is used internally to represent AEICmsLockMonitorObject */
typedef AEICmsLockMonitorObject _AEICmsLockMonitorObject;



/*! \brief Obj struct for InternetGatewayDevice.X_ACTIONTEC_COM_RemoteConsole.
 *
 * MDMOID_REMOTE_CONSOLE 4560
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
...
/*! \brief Obj struct for InternetGatewayDevice.X_ACTIONTEC_COM.
 *
 * MDMOID_IGDAEI 4100
 */
typedef struct
...
/*! \brief _IGDAEIObject is used internally to represent IGDAEIObject */
typedef IGDAEIObject _IGDAEIObject;



/*! \brief Obj struct for InternetGatewayDevice.X_ACTIONTEC_COM.CUJO.
 *
 * MDMOID_IGDAEI_CUJO 4101
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
    UBOOL8    enable;	/**< Enable */
    UBOOL8    deviceIntelligence;	/**< DeviceIntelligence */
    UBOOL8    advancedParentalControls;	/**< AdvancedParentalControls */
    UBOOL8    ioTSecurity;	/**< IoTSecurity */
    UBOOL8    safeBrowsing;	/**< SafeBrowsing */
    UBOOL8    restart;	/**< Restart */
    char *    status;	/**< Status */
    char *    deviceIntelligenceStatus;	/**< DeviceIntelligenceStatus */
    char *    advancedParentalControlsStatus;	/**< AdvancedParentalControlsStatus */
    char *    ioTSecurityStatus;	/**< IoTSecurityStatus */
    char *    safeBrowsingStatus;	/**< SafeBrowsingStatus */
} IGDAEICujoObject;

/*! \brief _IGDAEICujoObject is used internally to represent IGDAEICujoObject */
typedef IGDAEICujoObject _IGDAEICujoObject;



/*! \brief Obj struct for InternetGatewayDevice.X_ACTIONTEC_COM.CUJO.CrashLogHistory.{i}.
 *
 * MDMOID_IGDAEI_CUJO_C_L_H 4102
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
    DATETIME  time;	/**< Time */
    SINT32    filesize;	/**< filesize */
} IGDAEICujoCLHObject;

/*! \brief _IGDAEICujoCLHObject is used internally to represent IGDAEICujoCLHObject */
typedef IGDAEICujoCLHObject _IGDAEICujoCLHObject;
...
/*! \brief Obj struct for InternetGatewayDevice.X_ACTIONTEC_COM_CDROUTER_TESTMODE.
 *
 * MDMOID_AEICD_ROUTER_TEST_MODE 5560
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
    UBOOL8    enable;	/**< Enable */
} AEICDRouterTestModeObject;

/*! \brief _AEICDRouterTestModeObject is used internally to represent AEICDRouterTestModeObject */
typedef AEICDRouterTestModeObject _AEICDRouterTestModeObject;
