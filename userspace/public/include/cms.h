...
#if defined(SUPPORT_IPV6) || defined(GPL_A_CONTROL_LAYER)
...
#if defined(GPL_A_QUANTENNA_SUPPORT)
  #if defined(GPL_A_QTN_WIRELESS_RGMII)
  #ifdef SUPPORT_LANVLAN
   #if defined(GPL_CODE_B_LAN_SUBNET_5G) || defined(GPL_CODE_B_PUBLIC_WIFI)
...
#if defined(GPL_CODE_C) || defined(GPL_CODE_B_UPGRADE_MEM_CHECK)
#define SZ_1KB 1024
#endif
#if defined(GPL_CODE_B_UPGRADE_MEM_CHECK)
