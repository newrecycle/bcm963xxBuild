...
#endif
#if defined(GPL_CODE_A_DHCP_OPTION66)|| defined(GPL_CODE_A_DHCP_OPTION120)
...
#if defined(GPL_CODE_B_DHCP_LEASE) || defined(GPL_CODE_T) || defined(GPL_CODE_C)
...
#if defined(GPL_CODE_B_DHCPD_VENDOR_POOL)
...
#if defined(GPL_CODE_B_STB_NO_FIREWALL)
#define NIPQUID(addr) \
...
#ifndef GPL_CODE_B_DHCP_AUTO_RESERVATION
...
#endif
#endif
#if defined(GPL_CODE_B_DHCP_AUTO_RESERVATION) ||  defined(GPL_CODE_B_DHCP_AUTO_RESERVATION)
			if (!packet.yiaddr)
...
#if defined(GPL_CODE_T) && defined(GPL_CODE_B_DHCP_LEASE)
...
#endif
#ifdef GPL_CODE_A_DHCP_OPTION66
...
#endif
#ifdef GPL_CODE_A_DHCP_OPTION67
          if (curr->data[OPT_CODE] == DHCP_BOOT_FILE) 
          { 
#ifdef GPL_CODE_B_R3000       
               char *verdid = NULL;
...
#endif
#ifdef GPL_CODE_A_DHCP_OPTION120
...
#if defined(GPL_CODE_B_FEATURE_GATEWAY_CAPABILITY)
